...
func (x *Processors) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *Processors) GetRuntime() string {
	if x != nil {
		return x.Runtime
	}
	return ""
...
func (x *ResultsStats) GetCount() string {
	if x != nil {
		return x.Count
	}
	return ""
...
var file_service_proto_rawDesc = string([]byte{
	...
	0x72, 0x73, 0x52, 0x65, 0x61, 0x64, 0x22, 0x3a, 0x0a, 0x0a, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73,
	0x73, 0x6f, 0x72, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01,
	...
	0x6d, 0x65, 0x22, 0x12, 0x0a, 0x10, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x53, 0x74, 0x61,
	0x74, 0x73, 0x52, 0x65, 0x61, 0x64, 0x22, 0x24, 0x0a, 0x0c, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74,
	0x73, 0x53, 0x74, 0x61, 0x74, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x2a, 0x70, 0x0a, 0x0c,
	...
	0x54, 0x55, 0x53, 0x5f, 0x53, 0x55, 0x43, 0x45, 0x45, 0x44, 0x45, 0x44, 0x10, 0x02, 0x32, 0xb2,
	...
	0x61, 0x74, 0x73, 0x32, 0x82, 0x01, 0x0a, 0x0d, 0x4f, 0x72, 0x63, 0x61, 0x50, 0x72, 0x6f, 0x63,
...
var file_service_proto_depIdxs = []int32{
	...
	27, // 5: Result.struct_value:type_name -> google.protobuf.Struct
	...
	19, // 22: OrcaCore.ReadWindowTypes:input_type -> WindowTypeRead
	21, // 23: OrcaCore.ReadAlgorithms:input_type -> AlgorithmsRead
	23, // 24: OrcaCore.ReadProcessors:input_type -> ProcessorsRead
	25, // 25: OrcaCore.ReadResultsStats:input_type -> ResultsStatsRead
	12, // 26: OrcaProcessor.ExecuteDagPart:input_type -> ExecutionRequest
	16, // 27: OrcaProcessor.HealthCheck:input_type -> HealthCheckRequest
	15, // 28: OrcaCore.RegisterProcessor:output_type -> Status
	5,  // 29: OrcaCore.EmitWindow:output_type -> WindowEmitStatus
	20, // 30: OrcaCore.ReadWindowTypes:output_type -> WindowTypes
	22, // 31: OrcaCore.ReadAlgorithms:output_type -> Algorithms
	24, // 32: OrcaCore.ReadProcessors:output_type -> Processors
	26, // 33: OrcaCore.ReadResultsStats:output_type -> ResultsStats
	13, // 34: OrcaProcessor.ExecuteDagPart:output_type -> ExecutionResult
	17, // 35: OrcaProcessor.HealthCheck:output_type -> HealthCheckResponse
